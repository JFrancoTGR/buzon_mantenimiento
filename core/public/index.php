...
<body class="app-page">
          ...
          >
            ...
            >
              ...
              <div class="tool-card__body">
                ...
                <p>
                  Gestión de reportes, supervisión, autorizaciones y seguimiento de mantenimiento interno.
                </p>
              </div>
            ...
            >
              <div class="tool-card__header">
                ...
                <span class="tool-card__icon">
                  <svg aria-hidden="true">
                    <use href="#icon-intelligence"></use>
                  </svg>
                </span>
  ...
  >
    ...
    <symbol id="icon-maintenance" viewBox="0 0 24 24">
      <path
        d="m14.7 6.3 3-3a5 5 0 0 0-6.4 6.4L4 17v3h3l7.3-7.3a5 5 0 0 0 6.4-6.4l-3 3-3-3Z"
        fill="currentColor"
      />
    </symbol>
    ...
    <symbol id="icon-events" viewBox="0 0 24 24">
      <path
        d="M5 3h2v2h10V3h2v2h2v16H3V5h2V3Zm14 7H5v9h14v-9ZM5 7v1h14V7H5Z"
        fill="currentColor"
      />
    </symbol>
    ...
    <symbol id="icon-analytics" viewBox="0 0 24 24">
      <path
        d="M4 20V4h2v14h14v2H4Zm4-4V9h3v7H8Zm5 0V5h3v11h-3Zm5 0v-4h3v4h-3Z"
        fill="currentColor"
      />
    </symbol>
